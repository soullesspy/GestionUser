...
import com.gu.entidades.Usuarios;
 ...
 */
@Stateless
@Path("com.gu.entidades.usuarios")
public class UsuariosFacadeREST extends AbstractFacade<Usuarios> {

    @PersistenceContext(unitName = "GestionUserPU")
    private EntityManager em;

    public UsuariosFacadeREST() {
        super(Usuarios.class);
        this.em = Persistence.createEntityManagerFactory("GestionUserPU").createEntityManager();
    }
